...
static const crypto_onetimeauth_poly1305_implementation *implementation_poly1305 =
...
{
    return implementation_poly1305->onetimeauth(out, in, inlen, k);
}
...
{
    return implementation_poly1305->onetimeauth_verify(h, in, inlen, k);
}
...
{
    return implementation_poly1305->onetimeauth_init(state, key);
}
...
crypto_onetimeauth_poly1305_update(crypto_onetimeauth_poly1305_state *state,
                                   ...
                                   unsigned long long inlen)
{
    return implementation_poly1305->onetimeauth_update(state, in, inlen);
}
...
crypto_onetimeauth_poly1305_final(crypto_onetimeauth_poly1305_state *state,
                                  unsigned char *out)
{
    return implementation_poly1305->onetimeauth_final(state, out);
}
...
{
    implementation_poly1305 = &crypto_onetimeauth_poly1305_donna_implementation;
#if defined(HAVE_TI_MODE) && defined(HAVE_EMMINTRIN_H)
